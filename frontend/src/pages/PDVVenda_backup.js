      ...
      <div className="pdv-main">
        <div className="pdv-left">
          <div className="scanner-section">
            <div className="scanner-header">
              <h3><FaBarcode /> Scanner de Código</h3>
              <div className="scanner-controls">
                <button 
                  className={`scanner-btn ${scannerAtivo ? 'active' : ''}`}
                  onClick={scannerAtivo ? pararScanner : iniciarScanner}
                >
                  {scannerAtivo ? <FaCamera /> : <FaQrcode />}
            ...
            {showCamera && (
              <div className="camera-container">
                ...
                />
                <button className="capture-btn" onClick={capturarCodigoBarras}>
                  <FaCamera /> Capturar
                </button>
              </div>
            )}
                            ...
                            <div className="product-info">
                              ...
                              <div className="product-details">
                                {produto.codigo_barras && (
                                  <span className="product-code">Cód: {produto.codigo_barras}</span>
                                )}
                                <span className="product-price">{formatCurrency(produto.preco_venda || produto.preco || 0)}</span>
                              </div>
        ...
        <div className="pdv-right">
          <div className="cart-section">
                  ...
                  <div key={item.id} className="cart-item">
                    <div className="item-info">
                      ...
                      <div className="item-details">
                        {item.codigo_barras && <span>Cód: {item.codigo_barras}</span>}
            ...
            {carrinho.length > 0 && (
              <div className="action-buttons-section">
                ...
                >
                  <FaUser />
                  <div className="btn-content">
                    <span className="btn-title">Cliente</span>
                ...
                >
                  <FaCreditCard />
                  <div className="btn-content">
                    <span className="btn-title">Pagamento</span>
                    <span className="btn-subtitle">
                      {!cliente ? 'Selecione um cliente' : `Total: ${formatCurrency(calcularTotal())}`}
                    </span>
                  </div>
                </button>
              </div>
            ...
            {/* Seção de Pagamento no Carrinho */}
            {mostrarPagamento && (
              <div className="pagamento-overlay">
                <div className="pagamento-modal">
                  <div className="pagamento-header">
                    <h3><FaCreditCard /> Finalizar Pagamento</h3>
                    <button 
                      className="close-pagamento-btn"
                  ...
                  <div className="pagamento-content">
                    ...
                    <div className="formas-pagamento-modal">
                      ...
                      <button 
                        onClick={finalizarVenda}
                        disabled={loading || (metodoPagamento === 'dinheiro' && parseFloat(valorRecebido) < calcularTotal())}
                        className="finalizar-pagamento-btn"
                      >
                        <FaCreditCard />
                        {loading ? 'Processando...' : `Finalizar Pagamento - ${formatCurrency(calcularTotal())}`}
                      </button>
                    </div>
                  </div>
                </div>
            ...
            {/* Formulário de Cliente no Carrinho */}
            {mostrarClienteForm && (
              <div className="cliente-form-overlay">
                <div className="cliente-form">
                  <div className="form-header">
                    <h4><FaUser /> Registrar Cliente</h4>
                    <button 
                      ...
                      {clientes.map(clienteEncontrado => (
                        ...
                        >
                          <div className="client-item-info">
                            ...
                            {clienteEncontrado.cpf && <span className="client-item-cpf">{clienteEncontrado.cpf}</span>}
                          </div>
                          <FaCheck className="select-icon" />
                        </div>
                      ))}
                  ...
                  {/* Ou Registrar Novo */}
                  <div className="divider">
                    <span>ou registrar novo cliente</span>
                  </div>
